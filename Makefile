...
MULTUS_CNI_COMMIT=e723aabca8792ddd181167660e252a127a81b073
...
prep: clean
	...
	KUBE_VERSION=${KUBE_VERSION} KUBE_DASHBOARD_VERSION=${KUBE_DASHBOARD_VERSION} CEPH_CSI_COMMIT=${CEPH_CSI_COMMIT} COREDNS_COMMIT=${COREDNS_COMMIT} OPENSTACK_PROVIDER_COMMIT=${OPENSTACK_PROVIDER_COMMIT} MULTUS_CNI_COMMIT=${MULTUS_CNI_COMMIT} ./get-addon-templates
	mv templates ${BUILD}
